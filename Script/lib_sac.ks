...
function sac_start {
    ...
    when true then {
        ...
        local dt to t - sac_t.
        set sac_t to t.
        set sac_avc to sac_avc-ship:control:rotation*sac_cturn:inverse*dt.

        local tt to t - sac_t0.
        local mf to sac_dir_to_rotvec(sac_rotvec_to_dir(sac_zero_x + (sac_zero_v + sac_zero_a*tt/2)*tt):inverse*(sac_facing_old:inverse * ship:facing)).
        ...
        if tt > sac_ct {
            ...
            if tune {
                ...
                set sac_zero_x to sac_dir_to_rotvec(ship:facing:inverse * sac_new_target) - sac_zero_v*sac_ct.
                set sac_x0 to -sac_zero_x.
                set sac_v0 to av - sac_zero_v.
            ...
            if sac_yaw_debug {
                log mf:y+", "+tv:y+", "+ta:y+", "+sac_yaw_arr[0]+", "+sac_yaw_arr[1]+", "+c:y to "stat.csv".
            }
...
function sac_tune_x {
    ...
    if deb {
        log dc+", "+(c*100)+", "+acc+", "+dza+", "+za+", "+ac to "tune.csv".
    }
